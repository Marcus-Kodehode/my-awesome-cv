      ...
      <div className="container relative mx-auto space-y-16">
        ...
        <div className="grid items-start grid-cols-1 gap-12 text-white lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg leading-relaxed">
              My experience stems from working in customer service and client relations — where clear communication, structure and solving problems under pressure were part of the daily routine. The same mindset still guides how I work: steady, practical, and focused on delivering value to real users.
            </p>
          </div>
