...
export default function SkillCards() {
  const skillCards = [
    ...
    },
    {
      ...
      desc: "I’m dependable and loyal in team situations. I support others, keep calm under pressure, and help build a positive atmosphere — even when deadlines gets close.",
    },
    {
